		...
		<div className='bg-white shadow rounded-lg mb-6'>
			...
			<div className='p-4'>
				...
				{isOwnProfile ? (
					isEditing ? (
						<button
							className='w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#d95a44] hover:bg-[#c24e3a]'
							onClick={handleSave}
						>
							Save Profile
						</button>
